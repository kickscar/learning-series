...
Azure Container Registry를 만들고 ACR Tasks(클라우드 빌드)로 이미지를 빌드·푸시하는 실습(lab25).
...
- **lab25: ACR 생성 및 이미지 빌드/푸시** (`rg-lab25`)
  - `crlab25`(Basic) → Cloud Shell `az acr build` → Repositories 확인
