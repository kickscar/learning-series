# 05 Traffic Management & High Availability / 04 Azure Application Gateway

L7 Application Gateway를 만들어 HTTP 요청을 웹 VM에 분산하는 실습(lab14). LB(L4)와 리소스 모델·동작 방식의 차이를 확인한다.
