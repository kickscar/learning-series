...
MySQL Flexible Server의 자동 백업·PITR·Geo 백업을 이해하고, Point-in-Time Restore로 특정 시점의 새 서버를 복원하는 실습(lab22).
...
- **lab22: 백업 설정 및 PITR** (`rg-lab22`)
  - `mysql-lab22` + 데이터 → 백업 보존 확인 → PITR → `mysql-lab22-restore` 데이터 확인
