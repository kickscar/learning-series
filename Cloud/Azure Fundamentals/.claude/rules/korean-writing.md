...
### Azure Portal 메뉴
Portal UI 경로에서는 한글 메뉴명 그대로 사용 가능.
```
Azure Portal > 가상 머신 > **인스턴스 시작**
```
...
- 서비스명: Virtual Machine, Virtual Network, Storage Account, Container Apps 등
- 개념어: Subnet, Resource Group, Load Balancer, SKU, Ingress, Revision 등
