...
### 1. 자동 트리거 — writer 완료 후
writer가 draft 작성을 완료하면 자동 실행.
...
```
1. draft 파일 읽기
   - 섹션: .claude/draft/{ch_no}.{sec_no}.claude.notion.md
   - Gallery: .claude/draft/{ch_no}.gallery.claude.notion.md
2. 섹션 유형 판단 (이론 / 실습 / 혼합 / Gallery)
