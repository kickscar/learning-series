...
SMB/NFS로 마운트하는 공유 파일시스템 Azure Files를 이해하고, Ubuntu VM에 SMB 공유를 마운트해 파일을 읽고 쓰는 실습(lab17).
...
- **lab17: Azure File Share 생성 및 VM 마운트** (`rg-lab17`)
  - `stlab17` → SMB 공유 `data`(5 GiB) → `vm-lab17` 마운트 → 파일 쓰기/읽기
