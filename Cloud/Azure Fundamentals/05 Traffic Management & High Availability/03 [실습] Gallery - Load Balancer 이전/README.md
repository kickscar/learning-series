...
"Gallery Custom VNet 이전"에서 Private Subnet에 격리된 Gallery를 Public Load Balancer 뒤에 넣어, VM에 Public IP 없이 외부 노출을 여는 Gallery 실습.
...
- "Gallery Custom VNet 이전"의 "외부 접속 불가"가 해소됨
